CLASS ucl_art_nrooks DEFINITION
  FINAL
  FOR TESTING
  DURATION SHORT
  RISK LEVEL HARMLESS.
...
CLASS ucl_art_nrooks IMPLEMENTATION.
  ...
  METHOD new_by_num_samples.
    ...
    "When
    DATA(cut) = zcl_art_nrooks=>new_by_num_samples( 2 ).
  ...
  METHOD new_default.
    ...
    "When
    DATA(cut) = zcl_art_nrooks=>new_default( ).
  ...
  METHOD new_copy.
    ...
    "Given
    DATA(sampler) = zcl_art_nrooks=>new_by_num_samples( 2 ).

    "When
    DATA(cut) = zcl_art_nrooks=>new_copy( sampler ).
